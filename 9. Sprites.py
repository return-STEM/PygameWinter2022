...
# (NEW) let's define constants for the generator random number bounds so it's easier to tune
PLATFORM_WIDTH_MIN = 160
...
def main():
    ...
    while True:
        ...
        while generator_position < SCREEN_W:
            ...
            gap_width = random.randint(GAP_WIDTH_MIN, GAP_WIDTH_MAX)
